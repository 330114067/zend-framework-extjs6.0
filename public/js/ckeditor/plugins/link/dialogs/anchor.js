	...
	return {
		...
		onOk : function() {
			...
			if (this._.selectedElement)
				...
				b.collapsed ? (a = d(c, a), b.insertNode(a)) : (CKEDITOR.env.ie
		...
		onShow : function() {
			var a = c.getSelection(), b = a.getSelectedElement(), d = b
					&& b.data("cke-realelement"), e = d ? CKEDITOR.plugins.link
					.tryRestoreFakeAnchor(c, b) : CKEDITOR.plugins.link
					.getSelectedLink(c);
			if (e) {
