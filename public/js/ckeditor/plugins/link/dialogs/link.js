...
(function() {
	CKEDITOR.dialog.add("link", function(e) {
		var m = CKEDITOR.plugins.link, p, q = function() {
			var a = this.getDialog(), b = a.getContentElement("target",
					"popupFeatures"), a = a.getContentElement("target",
					"linkTargetName"), n = this.getValue();
			if (b && a)
				switch (b = b.getElement(), b.hide(), a.setValue(""), n) {
					case "frame" :
		...
		return {
			title : b.title,
			minWidth : "moono-lisa" == (CKEDITOR.skinName || e.config.skin)
					? 450
					: 350,
			minHeight : 240,
			contents : [{
				...
				elements : [{
							...
							label : b.type,
							"default" : "url",
							items : [[b.toUrl, "url"], [b.toAnchor, "anchor"],
									[b.toEmail, "email"]],
							onChange : function() {
								var a = this.getDialog(), b = ["urlOptions",
										"anchorOptions", "emailOptions"], n = this
										.getValue(), d = a.definition
										.getContents("upload"), d = d
										&& d.hidden;
									...
									onKeyUp : function() {
										...
										var a = this.getDialog()
												.getContentElement("info",
														"protocol"), b = this
												.getValue(), c = /^((javascript:)|[#\/\.\?])/i, d = /^(http|https|ftp|news):\/\/(?=.)/i
												.exec(b);
										d
												? (this.setValue(b
														.substr(d[0].length)), a
									...
									validate : function() {
										...
										return a.getContentElement("info",
												...
												&& "url" != a.getValueOf(
														"info", "linkType")
												? !0
												: !e.config.linkJavaScriptLinksAllowed
														&& /javascript\:/
																.test(this
																		.getValue())
				...
				elements : [{
					...
					children : [{
						...
						"default" : "notSet",
						style : "width : 100%;",
						items : [[c.notSet, "notSet"],
								[b.targetFrame, "frame"],
								[b.targetPopup, "popup"],
								[c.targetNew, "_blank"], [c.targetTop, "_top"],
								[c.targetSelf, "_self"],
					...
					children : [{
								...
								children : [{
											...
											validate : CKEDITOR.dialog.validate
													.inlineStyle(e.lang.common.invalidInlineStyle),
											setup : f,
											commit : l
										}]
							}, {
			...
			onShow : function() {
				var a = this.getParentEditor(), b = a.getSelection(), c = b
						.getSelectedElement(), d = this.getContentElement(
						"info", "linkDisplayText").getElement().getParent()
						.getParent(), e = null;
				(e = m.getSelectedLink(a)) && e.hasAttribute("href") ? c
						|| (b.selectElement(e), c = e) : e = null;
			...
			onOk : function() {
				...
				if (this._.selectedElement) {
					var d = this._.selectedElement, g = d
							.data("cke-saved-href"), h = d.getHtml(), f;
					d.setAttributes(c.set);
					d.removeAttributes(c.removed);
					if (a.linkText && p != a.linkText)
						f = a.linkText;
					else if (g == h || "email" == a.type
							&& -1 != h.indexOf("@"))
						f = "email" == a.type
								? a.email.address
							...
							? (a = new CKEDITOR.dom.text(
									a.linkText
											|| ("email" == a.type
													? a.email.address
													: c.set["data-cke-saved-href"]),
									e.document), b.insertNode(a), b
									.selectNodeContents(a))
							: p !== a.linkText
									&& (a = new CKEDITOR.dom.text(a.linkText,
											e.document), b
											.shrink(CKEDITOR.SHRINK_TEXT), e
											.editable().extractHtmlFromRange(b), b
											.insertNode(a));
					a = b._find("a");
			...
			onFocus : function() {
				...
				a
						&& "url" == a.getValue()
						&& (a = this.getContentElement("info", "url"), a
								.select())
			}
		}
	})
