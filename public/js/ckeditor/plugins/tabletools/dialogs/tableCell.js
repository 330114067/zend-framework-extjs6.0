...
CKEDITOR.dialog.add("cellProperties", function(g) {
	...
	var h = g.lang.table, c = h.cell, e = g.lang.common, k = CKEDITOR.dialog.validate, n = /^(\d+(?:\.\d+)?)(px|%)$/, f = {
		type : "html",
		html : "\x26nbsp;"
	}, p = "rtl" == g.lang.dir, m = g.plugins.colordialog;
	return {
		title : c.title,
		minWidth : CKEDITOR.env.ie && CKEDITOR.env.quirks ? 450 : 410,
		minHeight : CKEDITOR.env.ie
				&& (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ? 230 : 220,
		contents : [{
			id : "info",
			label : c.title,
			accessKey : "I",
				...
				children : [{
					...
					children : [{
						...
						children : [{
							...
							onLoad : function() {
								var a = this.getDialog().getContentElement(
										"info", "widthType").getElement(), b = this
										.getInputElement(), c = b
										.getAttribute("aria-labelledby");
								b.setAttribute("aria-labelledby", [c, a.$.id]
												.join(" "))
							},
							setup : d(function(a) {
										var b = parseInt(a
							...
							commit : function(a) {
								var b = parseInt(this.getValue(), 10), c = this
										.getDialog().getValueOf("info",
												"widthType")
										|| l(a);
								isNaN(b) ? a.removeStyle("width") : a.setStyle(
										"width", b + c);
						...
						children : [{
							...
							onLoad : function() {
								var a = this.getDialog().getContentElement(
										"info", "htmlHeightType").getElement(), b = this
										.getInputElement(), c = b
										.getAttribute("aria-labelledby");
								b.setAttribute("aria-labelledby", [c, a.$.id]
												.join(" "))
						...
						label : c.hAlign,
						"default" : "",
						items : [[e.notSet, ""], [e.alignLeft, "left"],
						...
						commit : function(a) {
							var b = this.getValue();
							b ? a.setStyle("vertical-align", b) : a
					...
					children : [{
								...
								children : [{
									...
									"class" : "colorChooser",
									label : c.chooseColor,
									style : (p ? "margin-right" : "margin-left")
											+ ": 10px",
									onLoad : function() {
										this.getElement().getParent().setStyle(
												"vertical-align", "bottom")
		...
		onShow : function() {
			this.cells = CKEDITOR.plugins.tabletools
					.getSelectedCells(this._.editor.getSelection());
